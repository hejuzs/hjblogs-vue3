    ...
    <div class="w-full py-5 px-2 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col items-center">
            ...
            <div class="relative mb-4">
                <img class="w-14 h-14 rounded-full shadow max-w-[60px] max-h-[60px]"
                :src="blogSettingsStore.blogSettings.avatar"/>  
                <!-- bug修复：max-w-[60px]/max-h-[60px]：兜底限制，确保图片不超出 60px 防止上传的图片尺寸过大撑大盒子 -->  
                <span
            ...
            <div class="flex justify-center gap-5 mb-2">
                ...
                <div @click="router.push('/archive/list')"
                    class="flex items-center flex-col gap-1 hover:text-sky-600 hover:scale-110 cursor-pointer dark:text-gray-400">
                    <!-- 字体大小为 text-lg , 字体加粗 -->
                ...
                <div class="flex items-center flex-col gap-1 hover:text-sky-600 hover:scale-110 cursor-pointer dark:text-gray-400">
            ...
            <div class="flex justify-center gap-2">
                ...
                <svg @click="jump(blogSettingsStore.blogSettings.githubHomepage)" v-if="blogSettingsStore.blogSettings.githubHomepage" t="1698029949662" data-tooltip-target="github-tooltip-bottom" data-tooltip-placement="bottom"
                    class="hover:scale-110 cursor-pointer icon mt-5 w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <div id="csdn-tooltip-bottom" role="tooltip"
                    class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded shadow-sm opacity-0 tooltip dark:bg-gray-700">
                    我的 CSDN
                    <div class="tooltip-arrow" data-popper-arrow></div>
                </div>
            </div>
